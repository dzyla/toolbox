...
export const TOOLS: ToolMeta[] = [
  ...
  { id: 'sequence', name: 'Sequence Annotator', category: 'sequences', icon: '🔤',
    blurb: 'Select, colour, annotate, and analyse protein, DNA, and RNA sequences', keywords: ['sequence', 'fasta', 'annotation', 'viewer', 'protein', 'dna', 'rna'],
  ...
  { id: 'qpcr', name: 'qPCR / RT-qPCR Analyzer', category: 'sequences', icon: '📈',
    blurb: 'Import Cq tables, check standard curves, and calculate relative expression', keywords: ['qpcr', 'rt-qpcr', 'qPCR', 'cq', 'ct', 'miqe', 'delta delta cq', 'ddcq', 'pfaffl', 'gene expression'],
    status: 'ready', load: () => import('./qpcr/View') },
