...
function RunFractionsPanel({ audit }: { audit: WorkbenchAudit }) {
  ...
  const [selectedFractionLabels, setSelectedFractionLabels] = useState<string[]>([]);
